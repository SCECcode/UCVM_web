...
if [ $LD_LIBRARY_PATH ] ; then
  export LD_LIBRARY_PATH=$UCVM_INSTALL_PATH/lib/euclid3/lib:$UCVM_INSTALL_PATH/lib/proj-5/lib:$UCVM_INSTALL_PATH/model/cvmh1511/lib:$UCVM_INSTALL_PATH/model/cvms426/lib:$LD_LIBRARY_PATH
    ...
    export LD_LIBRARY_PATH=$UCVM_INSTALL_PATH/lib/euclid3/lib:$UCVM_INSTALL_PATH/lib/proj-5/lib:$UCVM_INSTALL_PATH/model/cvmh1511/lib:$UCVM_INSTALL_PATH/model/cvms426/lib
fi
...
export DYLD_LIBRARY_PATH=$UCVM_INSTALL_PATH/lib/euclid3/lib:$UCVM_INSTALL_PATH/lib/proj-5/lib:$UCVM_INSTALL_PATH/model/cvmh1511/lib:$UCVM_INSTALL_PATH/model/cvms426/lib
