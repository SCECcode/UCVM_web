...
<script type="text/javascript" src="js/ucvm_viz.js"></script>
</head>
<body>
<div class="container-fluid">
  ...
  <div class="row" id="controlBlock" style="margin:0px 0px 20px 30px; width:100%;display:flex;">
    ...
    <div class="row col-md-3 col-xs-3" style="display:inline-block;" >
      <div class="row">
        <button id="propertyBtn" class="btn ucvm-top-btn" style="width:21vw" title="get material property " onclick="propertyClick();">
        <span class="glyphicon glyphicon-star"></span> Query material property</button>
        <div id="spinIconForProperty" align="center" class="the-spin-icons" title="Code: 0xe839" style="visibility:hidden"><i class="spin-icon animate-spin">&#xe839;</i></div>
      </div>
    </div>
    <div class="row col-md-3 col-xs-3" style="display:inline-block;">
      <div>
        ...
        <div id="spinIconForVertical" align="center" class="the-spin-icons" title="Code: 0xe839" style="display:none"><i class="spin-icon animate-spin">&#xe839;</i></div>
      </div>
    </div>
    <div class="row col-md-3 col-xs-3" style="display:inline-block;">
      <div class="row">
...
<div class="row" id='resultBlock' style="position:relative;left:30px;width:24%;">
