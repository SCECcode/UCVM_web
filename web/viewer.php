...
<div id="miscTools">
  <div class="d-flex flex-row justify-content-end">
    <button class="btn ucvm-small-btn" title="display CFM7.0 faults" onclick='toggleShowCFM()'>
       <span id="ucvm_cfm_btn" class="glyphicon glyphicon-ok-sign"></span>CFM7.0</button>
